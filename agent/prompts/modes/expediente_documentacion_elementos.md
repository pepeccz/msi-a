...
2. Llama `enviar_imagenes_ejemplo(tipo="elemento", codigo_elemento="CÓDIGO", categoria="SLUG")` para mostrar fotos de ejemplo. Di "voy a enviarte fotos de ejemplo" ANTES de llamar a la herramienta.
