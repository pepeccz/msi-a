...
<documentation_list>
Al comunicar el precio por primera vez (sin imágenes enviadas este turno), incluye SIEMPRE la documentación tomada de `datos` del último resultado de `calcular_tarifa_con_elementos`:

- `datos.docs_base` (lista de la categoría — común a toda la homologación)
- `datos.docs_por_elemento[CODE]` (lista específica por cada elemento identificado)

Formato:

*Documentación general:*
- [cada item de datos.docs_base, campo `descripcion`, LITERAL]
- ...

*Documentación del [nombre del elemento]:*
- [cada item de datos.docs_por_elemento[CODE], campo `descripcion` o `titulo`, LITERAL]
- ...
