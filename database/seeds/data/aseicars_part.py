...
ELEMENTS: list[ElementData] = [
    ...
    },
    {
        ...
        "warnings": [
            {
                "code": "placas_regulador_info_part",
    ...
    },
    {
        ...
        "warnings": [
            {
                "code": "bola_remolque_proyecto_part",
    ...
    },
    {
        ...
        "warnings": [
            {
                "code": "placa_boletin_bt_part",
                "message": "Requiere Boletin de Baja Tension (+65 EUR).",
                "severity": "warning",
            },
        ],
    },
    ...
    },
    {
        ...
        "warnings": [
            {
                "code": "aumento_plazas_consulta_part",
    ...
    },
    {
        ...
        "images": [
            {
                "title": "Ficha tecnica",
                "description": "Ficha tecnica con nueva clasificacion",
                "image_type": "example",
                "sort_order": 1,
            },
            {
                "title": "ITV vigente",
                "description": "Documentacion del ITV industrial vigente",
                "image_type": "required_document",
                "sort_order": 2,
            },
        ],
        "warnings": [
            {
                "code": "cambio_clasif_con_itv_part",
                "message": "Mantener ITV industrial puede tener requisitos adicionales.",
                "severity": "info",
            },
        ],
    },
    {
        ...
        "images": [
            ...
            {
                "title": "Documentacion cambio",
                "description": "Documentacion del cambio de clasificacion",
                "image_type": "required_document",
                "sort_order": 2,
            },
        ],
        "warnings": [
            {
                "code": "cambio_clasif_sin_itv_part",
                "message": "Eliminar ITV industrial simplifica el proceso pero puede afectar al uso del vehiculo.",
                "severity": "info",
            },
        ],
    },
    ...
    # =========================================================================
    {
        ...
        "warnings": [
            {
                "code": "bola_sin_mmr_warning_part",
    ...
    # =========================================================================
    {
        ...
        "required_fields": [
            {
                "field_key": "marca_placa_solar",
                "field_label": "Marca de la placa solar",
                "field_type": "text",
                "is_required": True,
                "sort_order": 1,
            },
            {
                "field_key": "modelo_placa_solar",
                "field_label": "Potencia de la placa o Modelo de la placa",
                "field_type": "text",
                "is_required": True,
                "sort_order": 2,
            },
    ...
    },
    {
        ...
        "required_fields": [
            {
                "field_key": "marca_placa_solar",
                "field_label": "Marca Placa Solar",
                "field_type": "text",
                "is_required": True,
                "sort_order": 1,
            },
            {
                "field_key": "regulador_placa_solar",
                "field_label": "Marca del regulador",
                "field_type": "text",
                "is_required": True,
                "sort_order": 2,
            },
            {
                "field_key": "modelo_regulador",
                "field_label": "Modelo del regulador",
                "field_type": "text",
                "is_required": True,
                "sort_order": 3,
            },
            {
                "field_key": "contrasena_homologacion_regulador",
                "field_label": "Contraseña de homologacion del regulador",
                "field_type": "text",
                "is_required": True,
                "sort_order": 4,
            },
            {
                "field_key": "ubicacion_regulador",
                "field_label": "Ubicacion del regulador",
                "field_type": "text",
                "is_required": True,
                "sort_order": 5,
            },
    ...
    },
    {
        ...
        "required_fields": [
            ...
            {
                "field_key": "regulador_placa_solar",
                "field_label": "Marca del regulador solar",
                "field_type": "text",
                "is_required": True,
                "sort_order": 2,
            },
            {
                "field_key": "modelo_regulador_solar",
                "field_label": "Modelo del regulador solar",
                "field_type": "text",
                "is_required": True,
                "sort_order": 3,
            },
            {
                "field_key": "contrasena_homologacion_regulador",
                "field_label": "Contraseña de homologacion del regulador solar",
                "field_type": "text",
                "is_required": True,
                "sort_order": 4,
            },
            {
                "field_key": "ubicacion_regulador_solar",
                "field_label": "Ubicacion del regulador solar",
                "field_type": "text",
                "is_required": True,
                "sort_order": 5,
            },
    ...
    },
    {
        ...
        "warnings": [
            {
                "code": "toldo_galibo_medidas_part",
...
ADDITIONAL_SERVICES: list[AdditionalServiceData] = [
    ...
    },
    {
        ...
        "name": "Boletin electrico",
        "price": Decimal("65.00"),
        "sort_order": 5,
    },
    {
        "code": "certificado_gas",
        "name": "Certificado instalacion gas",
        "price": Decimal("65.00"),
        "sort_order": 6,
    },
    {
        "code": "envio_documentacion",
        "name": "Envio documentacion postal",
        "price": Decimal("15.00"),
        "sort_order": 7,
    },
]
...
BASE_DOCUMENTATION: list[BaseDocumentationData] = [
    {
        "code": "ficha_tecnica",
        "description": "Foto de la ficha tecnica del vehiculo (ambas caras, legible)",
        "sort_order": 1,
    },
    {
