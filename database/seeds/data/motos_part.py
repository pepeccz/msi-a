...
CATEGORY_WARNINGS: list[WarningData] = [
    {
        ...
        # Elements whose names/keywords match at runtime via trigger_conditions
        "associations": [
            "ESCAPE", "ESPEJOS", "INTERMITENTES", "INTERMITENTES_DEL", "INTERMITENTES_TRAS",
            "LLANTAS", "NEUMATICOS", "LUCES", "MANDOS_MANILLAR",
        ],
    },
    {
        ...
        "associations": ["HORQUILLA", "SUBCHASIS"],
    },
    {
        ...
        "associations": [
            "ANTINIEBLAS", "INTERMITENTES", "INTERMITENTES_DEL", "INTERMITENTES_TRAS",
            "LUCES", "MANDOS_MANILLAR",
        ],
    },
    {
